 ...
 *       'firstName' => 'Bobby',
 *       'lastName' => 'Tables',
 *       'fac-card-number' => '4444333322221111',
 *       'fac-card-cvc' => '123',
 *       'expdatemonth' => '12',
 *       'expdateyear' => '2017',
...
class CreditCard
{
     ...
     *
     * @param string $key Parameter key, e.g. 'expdateyear'
     * @param mixed $value Parameter value
     * @return CreditCard provides a fluent interface.
     */
    ...
    {
        foreach (array('fac-card-number', 'expdatemonth', 'expdateyear') as $key) {
    ...
    {
        return $this->getParameter('fac-card-number');
    }
    ...
    public function setNumber($value)
    {
        ...
        return $this->setParameter('fac-card-number', preg_replace('/\D/', '', $value));
    }
    ...
    {
        return $this->getParameter('expdatemonth');
    }
    ...
    {
        return $this->setParameter('expdatemonth', (int) $value);
    }
    ...
    {
        return $this->getParameter('expdateyear');
    }
    ...
    {
        return $this->setYearParameter('expdateyear', $value);
    }
    ...
    {
        return $this->getParameter('fac-card-cvc');
    }
    ...
    {
        return $this->setParameter('fac-card-cvc', $value);
    }
